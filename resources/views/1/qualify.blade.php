...
<section class="container">
	<div class="row">
		<div class="col-12">
			<h1 class="text-center grabber">Ok, Next Question:</h1>
		</div>
		<div class="col-lg-10 offset-lg-1 col-sm-12 offset-sm-0 stagecard">
			...
			<div class="col-10 offset-1">
				<h1 class="text-center bigquestion2">Was your baby given formula or fortifier before being diagnosed with NEC?</h1>
				<div class="row questions">
                    <div class="col-12 text-center questionbtn">
						<a href="/1/qualify-question2?q2=Yes"><button type="button" class="btn custombtn yes"><img id="yes" src="/assets/1/images/checkup.png" width="26" height="23" alt=""/> Yes</button></a>
					</div>
					<div class="col-12 text-center questionbtn">
						<a href="/1/qualify-question2?q2=no"><button type="button" class="btn custombtn no"><img id="no" src="/assets/1/images/checkup.png" width="26" height="23" alt=""/> No</button></a>
					</div>
					...
					<div class="">
						...
						<br>
						<hr>
						<p> <span class="noticeme">Alert:  Baby formula linked to NEC </span> If your baby was fed bottle formula and was subsequently diagnosed with NEC and sent to NICU, you may be entitled to significant compensation and a case review is 100% free, fast and easy!</p>
					</div>
		 ...
		 $(function() {
			 $('.yes').click(function(){
			   ...
			   $("#yes").attr('src',"/assets/1/images/checkdn.png");
                ...
                //Send FB Pixal Page View Request
                fbq('track', 'PageView');
			 });
			 $('.no').click(function(){
