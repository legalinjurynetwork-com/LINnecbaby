	...
	<div class="row">
		...
		<div class="col-lg-10 offset-lg-1 col-sm-12 offset-sm-0 stagecard">
			...
			<div class="col-10 offset-1">
				<h1 class="text-center bigquestion2">What year was your baby born? </h1>
				<div class="row questions">
                    <div class="col-12 text-center questionbtn">
						<a href="/1/info?q4=Before 2002"><button type="button" class="btn custombtn yes"><img id="yes" src="/assets/1/images/checkup.png" width="26" height="23" alt=""/> Before 2002</button></a>
					</div>
					<div class="col-12 text-center questionbtn">
						<a href="/1/info?q4=2002-2022"><button type="button" class="btn custombtn no"><img id="no" src="/assets/1/images/checkup.png" width="26" height="23" alt=""/> 2002-2022</button></a>
					</div>
