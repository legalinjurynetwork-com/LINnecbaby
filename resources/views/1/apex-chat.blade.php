...
<div class="mainstage">
    <script src="//www.apexchat.net/scripts/invitation.ashx?company=ypnecor" async></script>
</div>
<div class="fomoBar">
    <img src="/assets/1/images/exclaim.png" width="29" height="28" alt=""/> HURRY! If you are owed money, there is a limited time to file a complaint!
</div>
<section class="container about">
    <div class="row">
        <div class="col-sm-12">
            <h1> Companies did not warn about the dangers of cow’s milk-based formula for premature infants.  </h1>
        </div>
        <div class="col-sm-8 offset-sm-2">
            <center><p> Necrotizing enterocolitis (NEC) causes inflammation leading to intestinal tissue damage and tissue death. If the intestinal infection causes bowel perforation, the bacteria can pass into the baby’s bloodstream leading to even more severe complications. </p></center>
            <div class="spacer">&nbsp;</div>
        </div>
        <div class="col-lg-6 offset-lg-1 col-md-12">
            <center><img src="/assets/1/images/featured-image.jpg" alt="" class="img-fluid d-block mx-auto my-auto"/></center>
        </div>
        <div class="col-lg-4 col-md-12 bullets">
            <ul>
                <li>Between 15 and 40% of babies diagnosed with NEC die typically within hours or days. </li>
                <li>If your baby was fed bottle formula and was subsequently diagnosed with NEC and sent to NICU, you may be entitled to significant compensation. </li>
                <li>If this happened to you, you should talk to a lawyer asap! </li>
        ...
        <div class="col-lg-5 offset-lg-1 col-md-12">
            ...
            <h2 class="purple">NEC is the most common cause of death in hospitalized premature infants more than 2 weeks old.  </h2>
            <br>
            <p>NEC most often affects babies born prematurely or with a complication, such as a heart defect. </p>

            <p>If premature infants are fed cow-based milk products, they can develop necrotizing enterocolitis (NEC), a serious gastrointestinal condition that mostly affects premature babies resulting in inflammation and death of intestinal tissue.<br><br></p>


        </div>

        <div class="col-lg-6  col-md-12">
            <center><img src="/assets/1/images/feature-image.png" style="width:450px;height:auto;" alt="" class="img-fluid d-block mx-auto my-auto"/></center>
        </div>
        <div class="spacer">&nbsp;</div>
        <div class="spacer">&nbsp;</div>
        ...
        <div class="row">
            ...
            <div class="col-6 text-right">
                <ul class="list-inline text-right float-end">
                    <li><a href="https://{{ env('APP_DOMAIN') }}/terms" target="_blank">Terms &amp; Conditions</a> | </li>
                    <li><a href="https://{{ env('APP_DOMAIN') }}/privacy" target="_blank">Privacy Policy</a> |  </li>
                    <li><a href="https://{{ env('APP_DOMAIN') }}/ccpa" target="_blank">CCPA</a> | </li>
...
<script>
    $(function() {
        $('.yes').click(function(){
            ...
            $("#not").attr('src',"/assets/1/images/checkup.png");
        ...
        $('.not').click(function(){
            ...
            $("#yes").attr('src',"/assets/1/images/checkup.png");
            $("#no").attr('src',"/assets/1/images/checkup.png");
            $("#not").attr('src',"/assets/1/images/checkdn.png");
        });
    });
</script>
</html>
