        ...
        <div class="row-cols-1">
            <div class="formHolder">
                ...
                <div class="formBody">
                    ...
                    <div class="indicator"><img src="{{ asset('/img/Indicator_2.png') }}" alt="indicator"></div>
                    <h4 class="minHeight">Was your baby given formula or fortifier before being diagnosed with NEC?</h4>
                    <ul class="btnBox">
    ...
    $('a[id^="a-"]').on('click', function(){
        ...
        $.ajax({
            ...
            success: function (html) {
                if (html.sms == 1) {
                    window.location = "{{ route('nec.ques2') }}";
                } else {
