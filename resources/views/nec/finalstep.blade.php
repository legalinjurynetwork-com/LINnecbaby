  ...
  <div class="container-fliud">
    <div class="row-cols-1">
      <div class="formHolder finalForm">
        ...
        <div class="formBody">
          <h4>Final Step</h4>
          <div class="indicator"><img src="{{ asset('/img/Indicator_5.png') }}" alt="indicator"></div>
        ...
        <img src="{{ asset('/img/icon.png') }}" alt="icon" class="text-center finalIcon">
    ...
    .on('success.form.fv', function (e) {
        ...
        $.ajax({
            ...
            success: function (html) {
                if (html.sms == 1) {
                    window.location = "{{ route('nec.thankyou') }}";
                } else if (html.sms == 0) {
